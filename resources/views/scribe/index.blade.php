    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-v1-posts">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-posts">
                                <a href="#endpoints-POSTapi-v1-posts">Store a newly created resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-posts--id-">
                                <a href="#endpoints-GETapi-v1-posts--id-">Display the specified resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-posts--id-">
                                <a href="#endpoints-PUTapi-v1-posts--id-">Update the specified resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-posts--id-">
                                <a href="#endpoints-DELETEapi-v1-posts--id-">Remove the specified resource from storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-logout">
                                <a href="#endpoints-GETapi-v1-logout">GET api/v1/logout</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="xgoqzrhvxmhdsrakqad"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>xgoqzrhvxmhdsrakqad</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="klocko.kiara@example.net"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>klocko.kiara@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="tboyer@example.org"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>tboyer@example.org</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>ecujbpa</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/categories/5" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="PUTapi-v1-categories--id-"
               value="xymt"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>xymt</code></p>
        </div>
        </form>
...
<p>The ID of the category. Example: <code>5</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-posts">Display a listing of the resource.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-posts">Store a newly created resource in storage.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>avwyjon</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the categories table. Example: <code>nesciunt</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-v1-posts--id-">Display the specified resource.</h2>
...
<p>The ID of the post. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-posts--id-">Update the specified resource in storage.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="lxyvmsrpizofuslfguox"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>lxyvmsrpizofuslfguox</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>content</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="category_id"                data-endpoint="PUTapi-v1-posts--id-"
               value="qui"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the categories table. Example: <code>qui</code></p>
        </div>
        </form>

                    <h2 id="endpoints-DELETEapi-v1-posts--id-">Remove the specified resource from storage.</h2>
...
<p>The ID of the post. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-logout">GET api/v1/logout</h2>
